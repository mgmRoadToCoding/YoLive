<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="광고 이름" align="center" prop="advertName" />
      <el-table-column
        label="링크 주소"
        align="center"
        prop="advertAddress"
      ...
      <el-table-column label="순서대로 정렬" align="center" prop="sortNo" width="100" />
      <el-table-column
        label="사용 여부"
        align="center"
        prop="normalDisable"
      ...
      <el-table-column label="참고" align="center" prop="remark" width="100" />
      <el-table-column
        label="조작"
        align="center"
