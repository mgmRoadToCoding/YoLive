<template>
  <div class="app-container">
    ...
    >
      ...
      />
      <el-table-column label="결제 금액" align="center" prop="payAmount" />
      <el-table-column label="결제 방법" align="center" prop="payMethod">
        <template slot-scope="scope">
          <dict-tag
      ...
      <el-table-column label="결제 상태" align="center" prop="payStatus">
        <template slot-scope="scope">
          <dict-tag
      ...
      <el-table-column label="주문 상태" align="center" prop="orderStatus">
        <template slot-scope="scope">
          <dict-tag
