<template>
  <div class="app-container">
    <el-row :gutter="10" class="mb5">
      ...
      >
        <el-form-item label="유형" prop="type" class="el-form-search-item">
          <el-select
        ...
        <el-form-item label="상태" prop="state" class="el-form-search-item">
          <el-select
            ...
            size="mini"
          >
            <el-option label="승인 대기 중" value="0"></el-option>
            <el-option label="임대용" value="1"></el-option>
            <el-option label="임대" value="2"></el-option>
            <el-option label="선반에서 꺼내기" value="3"></el-option>
          </el-select>
        </el-form-item>
