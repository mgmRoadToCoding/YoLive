<template>
  <div class="app-container">
    <el-row :gutter="10" class="mb5">
      ...
      >
        <el-form-item label="명칭" prop="name" class="el-form-search-item">
          <el-input
        ...
        <el-form-item label="닉네임" prop="code" class="el-form-search-item">
          <el-input
    ...
    >
      ...
      <el-table-column label="명칭" align="center" prop="name" width="180" />
      <el-table-column
        label="구역"
        align="center"
        prop="areaCode"
      ...
      <el-table-column
        ...
        width="120"
      />
      <el-table-column label="녹색 비율" align="center" prop="green" width="80" />
      <el-table-column
        label="소개"
        align="center"
        prop="introduce"
      ...
      />
      <el-table-column label="참고" align="center" prop="remark" width="120" />
      <el-table-column
        label="조작"
        align="center"
