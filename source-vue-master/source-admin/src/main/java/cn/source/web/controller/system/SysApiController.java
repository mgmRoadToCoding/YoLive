...
//    public AjaxResult isExpiration(@RequestHeader(value = "Authorization", required = false) String authHeader) {
//        System.out.println("authHeader = " + authHeader); // 打印一下
//        if (authHeader != null && authHeader.startsWith("Bearer ")) {
//            String token = authHeader.substring(7);
//            return AjaxResult.success(tokenService.isExpiration(token));
//        } else {
//            return AjaxResult.error("认证失败，未提供有效的 token");
//        }
//    }
