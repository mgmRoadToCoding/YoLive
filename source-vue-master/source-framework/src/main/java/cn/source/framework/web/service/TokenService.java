...
public class TokenService
{
    ...
    /**
     * 通过原始token字符串获取用户身份信息（用于非HTTP场景，例如WebSocket）。
     *
     * @param rawToken JWT令牌字符串
     * @return 用户信息；如果无效或过期，返回null
     */
    public LoginUser getLoginUser(String rawToken)
    {
    ...
    public boolean isTokenValid(String rawToken)
    {
        ...
        try
        {
            return !isExpiration(rawToken) && getLoginUser(rawToken) != null;
        }
        catch (Exception e)
        {
            return false;
